...
import type { ExternalBlob as _ExternalBlob, Recording as _Recording, RecordingMetadata as _RecordingMetadata, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteRecording(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllRecordings(): Promise<Array<RecordingMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRecordings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecording(arg0: string): Promise<Recording> {
        if (this.processError) {
            try {
                ...
                return from_candid_Recording_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async saveRecording(arg0: string, arg1: RecordingMetadata, arg2: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveRecording(arg0, arg1, await to_candid_ExternalBlob_n15(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Recording_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Recording): Promise<Recording> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        measurements: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.measurements)
    };
}
